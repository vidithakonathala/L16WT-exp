...
app.get("/OIP",(req,res)=>
{
    res.sendFile(__dirname+"/OIP.jpg");
});
...
app.get('/logout', function(req, res) {
 ...
 app.get('/facultyjpg',(request,respond)=>{
    respond.sendFile(__dirname+"/faculty.png");
 });
 const a = "Bosu Babu";
con.query("select * from faculty1 where Faculty = ?",[a],(err,result)=>
{
    console.log(result[0]);
});
app.listen(3000,function(){console.log("Server starts at port 1000");});